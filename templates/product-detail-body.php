...
<main id="main-site">
    ...
    $data = $product->getOne($item_id)
        ?>
        <section id="product" class="py-3">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <img src="../static/image/products/<?php echo "{$data['image']}"?>" alt="product" class="img-fluid">
                    ...
                    <div class="col-sm-6 py-5">
                        <h5 class="font-baloo font-size-20"><?php echo "{$data['name']}"?></h5>
                        <small>by <?php echo "{$data['brand']}"?></small>
                        <div class="d-flex">
                        ...
                        <table class="my-3">
                            ...
                            <tr class="font-rale font-size-14">
                                <td>Deal Price:</td>
                                <td class="font-size-20 text-danger">$<span><?php echo "{$data['price']}"?></span><small
                    ...
                    <div class="col-12">
                        ...
                        <p class="font-rale font-size-14">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            ...
                            officia ducimus dolorum sed corrupti. Sapiente optio sunt provident, accusantium eligendi
                            eius
